class Statically {
    ...
    explain() {
        ...
        console.log("I had to change all the static and private elements, because the functions call for variables that exist within an initialized object.  That was the simplest way to fix the errors.");
    }
